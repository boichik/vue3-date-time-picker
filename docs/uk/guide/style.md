...
Цей розділ призначений для того, щоб показати вам, як ви можете стилізувати компоненти відповідно до ваших потреб.
<br>
Для стилізації <code>Vue3DateTimePicker</code> використовує CSS-змінні, що дозволяє гнучко їх налаштовувати. Стилі поділяються на два типи: базові та розширені

<p>Для того, щоб застосувати ваші зміни, необхідно кастомні стилі підключати після дефолтних:</p>

::: tip ПІДКАЗКА
У разі, якщо ви кастомізуєте абсолютно всі змінні, ви можете відмовитися від імпортування файлу <code>variables.css</code>
:::
...
Цей тип кастомізації складається з невеликої кількості змінних css, які можна використовувати для налаштування зовнішнього вигляду компонентів.
...
## Розширені можливості кастомізації

Якщо вам потрібно налаштувати певний компонент або змінити стилі більшості компонентів загалом, ви можете скористатися більш розширеним налаштуванням компонентів.
Нижче наведено змінні CSS для кожного компонента:
